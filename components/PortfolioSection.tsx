...
const PortfolioSection = () => {
  return (
    <section id="portfolio" className="py-20 text-center bg-gray-500 text-white">
      <div className="container mx-auto max-w-4xl">
        ...
        <p className="mt-4 text-lg text-white">- Frances Hodgson Burnett</p>

        {/* Projects Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
          {projects.map((project) => (
            <figure key={project.name} className="border border-black rounded-4xl overflow-hidden shadow-md">
        ...
        <div className="mt-12">
          <Link href="/projects" className="bg-black hover:bg-white hover:text-black text-white py-3 px-6 rounded-lg inline-block transition duration-300 focus-visible:ring focus-visible:ring-gray-500">
            View All Projects
          </Link>
        </div>
      </div>
